...
const char* ssid = "PHEONIX-CCDS";
const char* password = "PHEONIX###123";
...
<html>
<head>
  <title>PHEONIX Vehicle Crash Detection System</title>
  <style>
...
<body>
  <div class="container">
    <h1>PHEONIX Vehicle Crash Detection System</h1>
...
double current_lat = 7.254843858123293;
double current_long = 80.59160757278244;
...
void setup() {
  ...
  //Initialise the SIm800 Module 
  sim800.begin(9600, SERIAL_8N1, 32, 33); // RX=32, TX=33
...
void Impact() {
  ...
  // Adjusted sensitivity threshold3
...
*****************************************************************************************/
void sendAlert1() {
  Serial.println("in the send alert Fn");
  sim800.println("AT+CMGF=1"); //Once the handshake test is successful, it will back to OK
  updateSerial();

  sim800.println("AT+CMGF=1"); // Configuring TEXT mode
  updateSerial();
  sim800.println("AT+CMGS=\"+94 719980372\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
  updateSerial();
